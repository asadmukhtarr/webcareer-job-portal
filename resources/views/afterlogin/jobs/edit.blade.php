...
<div class="card job-card">
    <div class="card-header">
        <h4 class="mb-0"><i class="fa fa-briefcase text-main me-2"></i> {{ $vacancy->title }}</h4>
        <p class="text-muted mb-0">Update in the job details to Edit Your opening</p>
    </div>
    <div class="card-body">
    <form action="{{ route('jobs.update',$vacancy->id) }}" method="post">
        @csrf
        @method("PATCH")
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-control @error('type') is-invalid @enderror" name="type">
                        ...
                        <option value="Remote" {{ $vacancy->type == 'Remote' ? 'selected' : '' }}>Remote</option>
                    </select>
                </div>
                @error('type')
                    <div class="invalid-feedback d-block">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" 
                    rows="4" 
                    name="description" 
                    placeholder="Describe the role, responsibilities, and expectations...">{{ $vacancy->description }}</textarea>
            @error('description')
                <div class="invalid-feedback d-block">
                    <i class="fa fa-exclamation-circle me-1"></i> {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('requirements') is-invalid @enderror" 
                    rows="3" 
                    name="requirements" 
                    placeholder="List the qualifications and requirements...">{{ $vacancy->requirements }}</textarea>
            @error('requirements')
                <div class="invalid-feedback d-block">
                    <i class="fa fa-exclamation-circle me-1"></i> {{ $message }}
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-control @error('experience') is-invalid @enderror" name="experience">
                        ...
                        <option value="Executive" {{ $vacancy->experience == 'Executive' ? 'selected' : '' }}>Executive</option>
                    </select>
                </div>
                @error('experience')
                    <div class="invalid-feedback d-block">
